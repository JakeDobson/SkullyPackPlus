...
//  Skully Pack Plus
//  Created by Jacob Dobson on 7/3/17.
...
extension StickerCollectionVC: UICollectionViewDelegateFlowLayout { //conforming to datasource and delegate also by inheritance
